...
The square D4h cyclobutadiene is a transition state, not a ground
state minimum. Jahn–Teller distortion drops it to a rectangular D2h
minimum with alternating bond lengths (1.326 / 1.566 Å at
wB97X-D/def2-TZVP). The IBO table shows what that escape costs and
buys: delocalization surrendered for two isolated double bonds.
...
```
  ...
  C1-C2         2.010   1.010   1.000   0.000  (+0.008: σ+0.008, π+0.000, δ+0.000)
  C3-C4         2.010   1.010   1.000   0.000  (+0.008: σ+0.008, π+0.000, δ+0.000)
  C1-C4         0.972   0.972   0.000   0.000  (-0.003: σ-0.003, π+0.000, δ+0.000)
  C2-C3         0.972   0.972   0.000   0.000  (-0.003: σ-0.003, π+0.000, δ+0.000)
  C3-H7         0.969   0.969   0.000   0.000  (-0.023: σ-0.023, π+0.000, δ+0.000)
  C1-C3         0.012   0.012   0.000   0.000  (-0.001: σ-0.001, π+0.000, δ+0.000)
```
...
framework absorbing the strain of the 90° corners. That is the same
bent-bond early warning the nonplanar cyclopropenyl anion tripped.
The near-miss footnote fires (4 terms, largest −0.0055), so the
