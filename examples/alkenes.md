...
```
  ...
  C1-C2         2.034   1.034   1.000   0.000  (+0.017: σ+0.017, π+0.000, δ+0.000)
  C1-H3         0.978   0.978   0.000   0.000  (-0.009: σ-0.009, π+0.000, δ+0.000)   (×4)
```
...
```
  Bond         Total       σ       π       δ              (interference)
  C2-C3         1.984   1.013   0.971   0.000  (-0.017: σ-0.002, π-0.015, δ+0.000)
  C1-C2         1.040   1.028   0.012   0.000  (+0.016: σ+0.007, π+0.009, δ+0.000)
  C1-H4         0.973   0.976  -0.003   0.000  (-0.007: σ-0.004, π-0.003, δ+0.000)
  C1-H6         0.973   0.976  -0.003   0.000  (-0.007: σ-0.004, π-0.003, δ+0.000)
  C1-H5         0.983   0.983   0.000   0.000  (-0.007: σ-0.007, π+0.000, δ+0.000)
```
...
```
  Bond         Total       σ       π       δ              (interference)
  C3-H4         0.022   0.012   0.010   0.000  (+0.010: σ+0.005, π+0.005, δ+0.000)
  C3-H6         0.022   0.012   0.010   0.000  (+0.010: σ+0.005, π+0.005, δ+0.000)
```
...
```
  Bond         Total       σ       π       δ              (interference)
  C1-C4         1.936   0.997   0.939   0.000  (-0.041: σ-0.016, π-0.026, δ+0.000)
  C1-C2         1.028   1.016   0.012   0.000  (+0.008: σ+0.000, π+0.008, δ+0.000)
  C1-C3         1.028   1.016   0.012   0.000  (+0.008: σ+0.000, π+0.008, δ+0.000)
  C2-H5         0.973   0.976  -0.003   0.000  (-0.008: σ-0.005, π-0.003, δ+0.000)
  C2-H6         0.973   0.976  -0.003   0.000  (-0.008: σ-0.005, π-0.003, δ+0.000)
  C3-H8         0.973   0.976  -0.003   0.000  (-0.008: σ-0.005, π-0.003, δ+0.000)
  C3-H9         0.973   0.976  -0.003   0.000  (-0.008: σ-0.005, π-0.003, δ+0.000)
  C2-H7         0.984   0.984   0.000   0.000  (-0.006: σ-0.006, π+0.000, δ+0.000)
  C3-H10        0.984   0.984   0.000   0.000  (-0.006: σ-0.006, π+0.000, δ+0.000)
```
...
```
  Bond         Total       σ       π       δ              (interference)
  C4-H6         0.021   0.010   0.011   0.000  (+0.010: σ+0.005, π+0.005, δ+0.000)
  C4-H8         0.021   0.010   0.011   0.000  (+0.010: σ+0.005, π+0.005, δ+0.000)
  C4-H9         0.021   0.010   0.011   0.000  (+0.010: σ+0.005, π+0.005, δ+0.000)
  C4-H5         0.021   0.010   0.011   0.000  (+0.010: σ+0.005, π+0.005, δ+0.000)
```
