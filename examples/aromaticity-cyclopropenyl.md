...
(`C1(66.6%) + C4(17.7%) + C3(15.7%)`). PM localises virtuals
differently from occupieds even under perfect D3h symmetry. The
virtual block gets the same bond-flat tie-break as the occupied
block; the asymmetry above is PM localization itself differing
between blocks — see [../NOTES.md](../NOTES.md).
...
Let the geometry relax out of plane and the story changes. The HOMO
drops to −0.090 Ha — bound again. The carbanion LP rehybridises to
...
the bent-bond early warning working as designed: nonplanarity
defeats the σ/π symmetry separation. The planar anion shows no such
lines.
