...
def main():
    ...
    parser.add_argument("--spin", "--mult", type=int, default=1, dest="spin",
                        help="Spin multiplicity (default: 1; open-shell rejected)")
    ...
    cjson = {
        ...
        "properties": {
            "totalCharge": args.charge,
            "totalSpinMultiplicity": args.spin,
        },
    }
    options = {}
    if args.method:
    ...
    result = compute_ibo(cjson, options, charge=args.charge, spin=args.spin)
